<template>
    <div>
        <h2>Inmuebles en Adquisicion</h2>
                ...
                <tbody>
                    <tr v-for="(inmueble,i) in inmuebles" :key="i">
                        ...
                        <td>
                            ...
                            <a @click="iniciarProc(inmueble.IdInmueble)" class="ms-3" style="color">
...
export default {
  ...
  methods:{
      getInmuebles(){
        let adquisiciones = 1
        axios.get(process.env.VUE_APP_RUTA_API + 'inmueble/readXproceso.php?IdProceso='+ adquisiciones)
        .then((res) => {
          if (res.data) {
